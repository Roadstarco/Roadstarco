...
var username = 'IsaacImasuagbon';
var apiKey = 'process.env.FLIGHTAWARE_API_KEY';


var config = {
    method: 'get',
    url: 'https://aeroapi.flightaware.com/aeroapi/schedules/2022-04-19/2022-04-25?origin=KJFK&destination=KLAX',
    headers: { 
